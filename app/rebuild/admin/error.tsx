  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[hsl(var(--background))] p-4">
      <div className="max-w-md text-center space-y-4 rounded-2xl border border-rose-500/20 bg-rose-500/5 p-8">
        ...
        <h2 className="text-xl font-bold text-[hsl(var(--foreground))]">Erro no Painel Administrativo</h2>
        <p className="text-sm text-[hsl(var(--muted))]">
          Ocorreu um erro inesperado. Nenhuma operacao financeira foi afetada. Nossa equipe ja foi notificada.
        </p>
        {error.digest && (
